...
3, 4, and were given input lengths of 3, 4, 1, 5.
    ...
    The fourth length, 5, selects every element starting with the second: 4)
        ([3] 0 1 2. Reversing this sublist (3 0 1 2 4 into 4 2 1 0 3)
        produces: 3) ([4] 2 1 0.
...
lengths = [int(i) for i in sys.argv[1].split(',')]
sparse_hash, pos, skip_size = run_round(lengths, list(range(0, 256)))
